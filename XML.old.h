...
/* Class XMLdoc<> holds entities (&mdash; &nbsp; etc.) and the 'doctype' as a string.
 * It offers suitable getters (for doctype and entities) and setters (for entities).
 * It is neither a child nor a parent.
 * XMLroot<> holds references to an instance of XMLdoc<>
 * Should also each XMLelement<> hold a reference to a XMLdoc<>?
 * This class definition is being moved to "XMLdoc.h"
 */
