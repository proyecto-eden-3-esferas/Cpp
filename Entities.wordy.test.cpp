...
int main() {
  ...
  es.add_internal_entity(       "nbsp", "&#160;");
  es.add_internal_entity(       "date", "January 22nd, 1999");
  es.add_external_entity("posibilidad", "texts/posibilidad.xml");
  es.add_external_entity("result_file", "../result.txt");
  es.declare_doctype_and_entities(cout,
                                  "book",
                                  "/home/francisco/Documents/docbook.dtd");
